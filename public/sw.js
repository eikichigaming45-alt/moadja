const CACHE_NAME = 'moadja-cache-v1.96.22';
...
const ASSETS_TO_CACHE = [
    ...
    '/css/tchat.css',
    '/css/sport.css',
    '/css/sport-widget.css',
    '/css/sport-activite-libre.css',
    '/js/app.js',
    '/js/widgets.js',
    '/js/modal.js',
    '/js/profil.js',
    ...
    '/js/eclats.js',
    '/js/tchat.js',
    '/js/sport-gps-widget.js',
    '/js/sport-widget.js',
    '/js/sport.js',
    '/js/sport-activite-libre.js',
    '/js/sportRoutines.js',
