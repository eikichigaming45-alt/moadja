...
- **Partage de vos exploits** : Lorsque vous partagez une séance GPS à vos proches (via WhatsApp, etc.), l'image générée affiche désormais fièrement le joli tracé de votre parcours sur la carte.
- **Cartographie** : Le détail de vos anciennes séances GPS affiche maintenant une carte interactive de votre trajet.
...
- **Chronomètre intelligent** : Ajout de courts bips sonores et de vibrations lors des 5 dernières secondes de votre temps de repos pour vous préparer à reprendre l'exercice. 
- **Widgets interactifs** : Les cartes de résumé de vos séances sur l'accueil sont cliquables. En appuyant dessus, vous ouvrez tout le détail de l'entraînement (calories, volume, liste des exercices).
- **Moteur de recherche** : Ajout d'une barre de recherche performante dans le catalogue d'exercices (qui est maintenant entièrement traduit en français).
...
- **Résonances (Likes émotionnels)** : Vous pouvez réagir aux publications avec 4 émotions (Douceur 🩷, Énergie ⚡, Calme 🌙, Inspiration ✨).
- **Éclats (Stories)** : Partagez des photos éphémères qui disparaissent au bout de 24h.
...
- **Météo automatique** : Mémorisation de votre position pour vous afficher le temps qu'il fait dès l'ouverture de l'application.
...
## v1.00 - 24 août 2026 🏷️ Lancement
- **Naissance de MoaDja** : Lancement officiel de la plateforme sur moadja.fr !
- Fonctionnalités disponibles au lancement : Profil, Fil d'actualité, Planning, Tâches, Anniversaires, Suivi de Cycle, Islam (Prières), Astrologie, Administration.
