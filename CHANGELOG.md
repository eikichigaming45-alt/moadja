...
### ✨ Nouveau
- L'ouverture d'une photo dans la messagerie privée utilise désormais la grande visionneuse de l'application. L'affichage s'adapte parfaitement, que la photo soit en mode portrait ou paysage.
- Protection des médias : le menu d'options (clic droit) a été désactivé sur les photos agrandies.
- Nettoyage visuel du fil d'actualité : les mentions, les mots-clés et les badges de lieux adoptent une apparence plus douce (retrait du texte en gras et du soulignement au survol) tout en restant interactifs.

### 🔧 Corrections
- Amélioration majeure de la navigation sur mobile : utiliser le geste ou le bouton "Retour" de votre téléphone depuis la messagerie ferme désormais proprement une photo ouverte, ou vous ramène à la liste des discussions, sans jamais vous faire quitter brutalement l'application.
...
### ✨ Nouveau
- Harmonisation visuelle du fil d'actualité : les mentions (@Prénom Nom), les hashtags (#mot-clé) et les localisations affichent désormais tous la même couleur violette douce, sans halo ni surbrillance, pour une lecture plus homogène avec le reste de l'interface.
