...
11. Petit-déjeuner simple, rapide et réaliste : privilégier pain complet, biscottes/cracottes, œufs (dur, brouillé), yaourt ou fromage blanc (nature ou protéiné), flocons d'avoine, fruit entier ou pressé. Interdit : légumes cuits (épinards, brocolis, courgettes...) et préparations complexes le matin. Adapter la composition à l'objectif : plus protéiné/moins sucré si perte de poids, plus calorique/énergétique si prise de masse, équilibré si maintien.
12. Rotation des protéines/ingrédients : la source principale de protéines du déjeuner et du dîner (poulet, poisson, bœuf, dinde, œuf, légumineuses...) ne doit jamais être la même sur deux jours consécutifs. Un même ingrédient secondaire (ex : épinards, quinoa) ne doit pas apparaître à plus de 2 repas consécutifs.
